...
def drawBoard():
    ...
    def drawTriangles(x, y, o):  # OffsetX, OffsetY, Orientation(1 or -1)
        ...
        arcade.draw_triangle_filled((601 - x), (401 - y), (601 - x) + 30, (401 - y) + (300 * o), (601 - x) + 60,
                                    (401 - y), color1)
        arcade.draw_triangle_filled((601 - x) + 60, (401 - y), (601 - x) + 90, (401 - y) + (300 * o), (601 - x) + 120,
                                    (401 - y), color2)
        arcade.draw_triangle_filled((601 - x) + 120, (401 - y), (601 - x) + 150, (401 - y) + (300 * o), (601 - x) + 180,
                                    (401 - y), color1)
        arcade.draw_triangle_filled((601 - x) + 180, (401 - y), (601 - x) + 210, (401 - y) + (300 * o), (601 - x) + 240,
                                    (401 - y), color2)
        arcade.draw_triangle_filled((601 - x) + 240, (401 - y), (601 - x) + 270, (401 - y) + (300 * o), (601 - x) + 300,
                                    (401 - y), color1)
        arcade.draw_triangle_filled((601 - x) + 300, (401 - y), (601 - x) + 330, (401 - y) + (300 * o), (601 - x) + 360,
                                    (401 - y), color2)
