...
# Data:
Data_rollOptions = [(1, 1), (1, 2), (1, 3), (1, 4), (1, 5), (1, 6), (2, 2), (2, 3), (2, 4), (2, 5), (2, 6), (3, 3),
...
def PipMinMaxBasic(subTurn: SubTurn, player, Max=True):
    ...
    if len(pipList) == 0:
        pipDiff = (subTurn.Board.pip[1] - subTurn.Board.pip[0]) if player == 1 else (
                    subTurn.Board.pip[0] - subTurn.Board.pip[1])
        return pipDiff
